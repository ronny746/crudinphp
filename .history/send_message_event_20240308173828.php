...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST['user_id']) || !isset($_POST['sender_name']) || !isset($_POST['message'])) {
        echo json_encode(array("message" => "User ID , sender name and message are required"));
        exit;
    }
    ...
    $updateQuery = "UPDATE userevent SET messages_by = '$senderName',new_message WHERE user_id = $userId";
