...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    // Fetch posts with full user details from the database
    $getPostsQuery = "SELECT posts.*, users.username, users.email FROM posts INNER JOIN users ON posts.user_id = users.id";
